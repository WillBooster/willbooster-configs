...
module.exports = {
  '{,scripts/**/,src/**/,test/**/}*.{cjs,cts,js,jsx,mjs,mts,ts,tsx}': ["node ../../node_modules/.bin/eslint --fix --rule \"{ react-hooks/exhaustive-deps: 0 }\"", 'node ../../node_modules/.bin/prettier --cache --write'],
